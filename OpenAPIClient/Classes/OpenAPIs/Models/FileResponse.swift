...
public struct FileResponse: Codable, JSONEncodable, Hashable {
    ...
    public var additionalProperties: FileResponseAdditionalProperties?

    public init(id: String, relatedObjectId: String?, relatedWorkflowId: String?, typeRefIds: [String], company: String, contentType: String, createdAt: String, createdBy: String, _extension: String, name: String, displayName: String, size: Double, type: String, url: String, savedToCloud: Bool, storageAuthProviderName: String, storageAuthProviderRefID: String, storageProvider: String, syncToEdge: Bool, typeRefID: String, additionalProperties: FileResponseAdditionalProperties?) {
        self.id = id
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(relatedWorkflowId, forKey: .relatedWorkflowId)
        try container.encode(typeRefIds, forKey: .typeRefIds)
