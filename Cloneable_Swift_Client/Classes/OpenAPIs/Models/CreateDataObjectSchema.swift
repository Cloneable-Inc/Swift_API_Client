...
public struct CreateDataObjectSchema: Codable, JSONEncodable, Hashable {
    ...
    public init(companyId: String, createdAt: Date, createdBy: String, fields: [DataObjectSchemaFieldsInner], modifiedAt: Date, objectDescription: String, objectDisplayName: String, objectTemplateId: String, objectName: String, objectRevision: Double, objectTemplateRevision: Double, typeRefId: String) {
