...
public struct TriggerExecutionSchema: Codable, JSONEncodable, Hashable {
    ...
    public init(id: UUID, triggerId: UUID, status: String, startedAt: Date, completedAt: Date?, error: String?, inputs: InsertTriggerExecutionSchemaInputs, outputs: InsertTriggerExecutionSchemaInputs, metadata: InsertTriggerExecutionSchemaMetadata, resourceUsage: InsertTriggerExecutionSchemaResourceUsage) {
        self.id = id
