//
// GetCompletedWorkflowsRequestFilters.swift
//
...
public struct GetCompletedWorkflowsRequestFilters: Codable, JSONEncodable, Hashable {
    ...
    public init(company: String? = nil, createdBy: String? = nil, createdAt: String? = nil, typeRefId: String? = nil, finalized: Bool? = nil, finalizedAt: String? = nil, workflowInstanceId: String? = nil, relatedObjectId: String? = nil) {
