...
open class DeployedWorfklowAPI {
     ...
     */
    @discardableResult
    open class func getDeployedWorkflows(getDeployedWorkflowsRequest: GetDeployedWorkflowsRequest? = nil, apiResponseQueue: DispatchQueue = Swift_API_ClientAPI.apiResponseQueue, completion: @escaping ((_ data: [DeployedWorkflowSchema]?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func getDeployedWorkflowsWithRequestBuilder(getDeployedWorkflowsRequest: GetDeployedWorkflowsRequest? = nil) -> RequestBuilder<[DeployedWorkflowSchema]> {
        ...
        let localVariableRequestBuilder: RequestBuilder<[DeployedWorkflowSchema]>.Type = Swift_API_ClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func getOneDeployedWorkflow(id: String, apiResponseQueue: DispatchQueue = Swift_API_ClientAPI.apiResponseQueue, completion: @escaping ((_ data: DeployedWorkflowSchema?, _ error: Error?) -> Void)) -> RequestTask {
