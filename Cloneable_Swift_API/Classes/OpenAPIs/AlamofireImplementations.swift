...
open class AlamofireRequestBuilder<T>: RequestBuilder<T> {
    ...
    @discardableResult
    override open func execute(_ apiResponseQueue: DispatchQueue = Cloneable_Swift_APIAPI.apiResponseQueue, _ completion: @escaping (_ result: Swift.Result<Response<T>, ErrorResponse>) -> Void) -> RequestTask {
            ...
            validatedRequest.response(queue: apiResponseQueue,
                ...
                do {
                    ...
                    if let headerFileName = self.getFileName(fromContentDisposition: dataResponse.response?.allHeaderFields["Content-Disposition"] as? String) {
                        ...
                        requestPath = requestPath.appending("/tmp.Cloneable_Swift_API.\(UUID().uuidString)")
                    }
