//
// CreateDeployedWorkflowSchemaComponentsInnerInputsInner.swift
//
...
public struct CreateDeployedWorkflowSchemaComponentsInnerInputsInner: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(dynamicInputId: String, inputClassification: String? = nil, group: String? = nil, inputDataType: String, inputDescription: String? = nil, inputId: String, inputName: String, _required: Bool? = nil, acceptsArray: Bool? = nil, trigger: Bool? = nil, additionalProperties: [String: JSONValue], jsonSchema: String? = nil, jsonSchemaId: String? = nil) {
