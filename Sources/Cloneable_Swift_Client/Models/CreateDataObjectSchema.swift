...
public struct CreateDataObjectSchema: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(id: UUID? = nil, dataObjectId: UUID, key: String, value: JSONValue? = nil, type: String, label: String? = nil, teamId: String? = nil, metaData: JSONValue? = nil, dataObjectTemplateNameId: String, createdAt: Date? = nil, createdBy: String? = nil, updatedAt: Date? = nil, updatedBy: String? = nil) {
        self.id = id
