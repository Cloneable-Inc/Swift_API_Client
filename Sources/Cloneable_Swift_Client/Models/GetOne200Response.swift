...
public struct GetOne200Response: Sendable, Codable, ParameterConvertible, Hashable {

    public var dataObjectId: String
    public var dataObjectTemplateNameId: String
    public var fields: [String: String]

    public init(dataObjectId: String, dataObjectTemplateNameId: String, fields: [String: String]) {
