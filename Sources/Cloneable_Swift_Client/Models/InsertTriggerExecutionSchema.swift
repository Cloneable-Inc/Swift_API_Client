...
public struct InsertTriggerExecutionSchema: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(id: UUID? = nil, triggerId: UUID, status: String, createdAt: Date? = nil, startedAt: Date? = nil, completedAt: Date? = nil, error: String? = nil, inputs: InsertTriggerExecutionSchemaInputs, outputs: InsertTriggerExecutionSchemaInputs, metadata: InsertTriggerExecutionSchemaMetadata, resourceLimits: InsertTriggerExecutionSchemaResourceLimits, resourceUsage: InsertTriggerExecutionSchemaResourceUsage) {
        self.id = id
