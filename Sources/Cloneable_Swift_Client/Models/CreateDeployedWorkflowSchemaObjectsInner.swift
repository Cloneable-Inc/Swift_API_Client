//
// CreateDeployedWorkflowSchemaObjectsInner.swift
//
...
public struct CreateDeployedWorkflowSchemaObjectsInner: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public var fields: [CreateDeployedWorkflowSchemaObjectsInnerFieldsInner]
    ...
    public init(company: String, createdAt: String, createdBy: String, objectDynamicCreateNewHandleId: String, dynamicObjectId: String, typeRefId: String, syncOnInputs: Bool, outputOnFieldChange: Bool, configuration: String, fields: [CreateDeployedWorkflowSchemaObjectsInnerFieldsInner], id: String, isTemplate: Bool, modifiedAt: String, modifiedBy: String, objectDescription: String, objectDisplayName: String, objectId: String, objectName: String, objectOutputDynamicId: String, revision: Double, type: String) {
...
extension CreateDeployedWorkflowSchemaObjectsInner: Identifiable {}
