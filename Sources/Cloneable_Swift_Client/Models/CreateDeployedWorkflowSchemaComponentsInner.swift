//
// CreateDeployedWorkflowSchemaComponentsInner.swift
//
...
public struct CreateDeployedWorkflowSchemaComponentsInner: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public var customizableParameters: [CreateDeployedWorkflowSchemaComponentsInnerCustomizableParametersInner]
    ...
    public var inputs: [CreateDeployedWorkflowSchemaComponentsInnerInputsInner]
    public var outputs: [CreateDeployedWorkflowSchemaComponentsInnerOutputsInner]
    public var resources: SaveWorkflowRequestResourcesInner?

    public init(id: String, availableToAllCompanies: Bool, availableDevices: [String], builderCompatibility: String, componentId: String, componentType: String, revision: Double, title: String, type: String, userCustomizedTitle: String? = nil, userCustomizedInstructions: String? = nil, dynamicComponentId: String, additionalProperties: [String: JSONValue]? = nil, nextButtonInBar: Bool? = nil, nextButtonInBarText: String? = nil, iosHwRequirements: [String]? = nil, customizableParameters: [CreateDeployedWorkflowSchemaComponentsInnerCustomizableParametersInner], componentDescription: String, dynamicComponentRenderer: Bool, useCustomViewForParams: Bool? = nil, implementationUrl: String, inputs: [CreateDeployedWorkflowSchemaComponentsInnerInputsInner], outputs: [CreateDeployedWorkflowSchemaComponentsInnerOutputsInner], resources: SaveWorkflowRequestResourcesInner? = nil) {
        self.id = id
...
extension CreateDeployedWorkflowSchemaComponentsInner: Identifiable {}
