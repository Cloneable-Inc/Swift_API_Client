//
// SyncDataObjectRequestInner.swift
//
...
public struct SyncDataObjectRequestInner: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(id: UUID? = nil, dataObjectId: String, dataObjectTemplateNameId: String, key: String, value: JSONValue? = nil, type: String, label: String? = nil, teamId: String? = nil, metaData: SyncDataObjectRequestInnerMetaData, createdAt: Date? = nil) {
        self.id = id
...
extension SyncDataObjectRequestInner: Identifiable {}
