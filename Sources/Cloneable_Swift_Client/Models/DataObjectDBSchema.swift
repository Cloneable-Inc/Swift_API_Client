...
public struct DataObjectDBSchema: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(id: UUID, dataObjectTemplateId: UUID, dataObjectTemplateNameId: String, createdAt: Date?, createdBy: String?, teamId: String?, updatedAt: Date?, updatedBy: String?, expiresAt: Int?, metaData: JSONValue?) {
        self.id = id
