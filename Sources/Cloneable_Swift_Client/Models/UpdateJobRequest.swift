...
public struct UpdateJobRequest: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(name: String? = nil, description: String? = "", configurationId: UUID? = nil, groupId: UUID? = nil, status: Status? = .pending, assignedTo: String? = nil, location: String? = nil, metadata: GetJobs200ResponseJobsInnerMetadata? = nil, importExecutionId: UUID? = nil, createdBy: String? = nil, archivedAt: Date? = nil) {
        self.name = name
