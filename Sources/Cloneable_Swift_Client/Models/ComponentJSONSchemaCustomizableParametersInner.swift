//
// ComponentJSONSchemaCustomizableParametersInner.swift
//
...
public struct ComponentJSONSchemaCustomizableParametersInner: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(paramName: String, paramDescription: String, paramDataType: String, paramInputType: String? = nil, paramID: String, selectedValue: JSONValue? = nil, userCustomizable: Bool? = nil) {
