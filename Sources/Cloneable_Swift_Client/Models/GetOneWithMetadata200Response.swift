//
// GetOneWithMetadata200Response.swift
//
...
public struct GetOneWithMetadata200Response: Sendable, Codable, ParameterConvertible, Hashable {

    public var dataObjectId: String
    public var dataObjectTemplateNameId: String
    public var fields: [GetOneWithMetadata200ResponseFieldsInner]

    public init(dataObjectId: String, dataObjectTemplateNameId: String, fields: [GetOneWithMetadata200ResponseFieldsInner]) {
