...
public struct CreateFileSchema: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(id: UUID? = nil, relatedObjectId: UUID? = nil, relatedWorkflowId: UUID? = nil, typeRefIds: [String]? = nil, company: String? = nil, contentType: String, createdAt: Date? = nil, createdBy: String? = nil, _extension: String, name: String, displayName: String, size: Double, type: String, url: String? = nil, savedToCloud: Bool? = nil, storageAuthProviderName: String? = nil, storageProvider: String? = nil, syncToEdge: Bool, typeRefID: String? = nil, additionalProperties: [String: JSONValue]? = nil) {
        self.id = id
