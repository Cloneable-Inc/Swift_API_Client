...
public struct DeployedWorkflowSchemaComponentsInner: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(id: String, availableToAllCompanies: Bool, availableDevices: [String], builderCompatibility: String, componentId: String, componentType: String, revision: Double, title: String, type: String, userCustomizedTitle: String? = nil, userCustomizedInstructions: String? = nil, dynamicComponentId: String, additionalProperties: [String: JSONValue]? = nil, nextButtonInBar: Bool? = nil, nextButtonInBarText: String? = nil, iosHwRequirements: [String]? = nil, customizableParameters: [DeployedWorkflowSchemaComponentsInnerCustomizableParametersInner], componentDescription: String, dynamicComponentRenderer: Bool, useCustomViewForParams: Bool? = nil, implementationUrl: String, inputs: [DeployedWorkflowSchemaComponentsInnerInputsInner], outputs: [DeployedWorkflowSchemaComponentsInnerOutputsInner], resources: SaveWorkflowRequestResourcesInner? = nil) {
        self.id = id
