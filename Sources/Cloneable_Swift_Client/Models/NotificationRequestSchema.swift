...
public struct NotificationRequestSchema: Sendable, Codable, ParameterConvertible, Hashable {

    public enum TargetCompanyRolesChannels: String, Sendable, Codable, CaseIterable {
        case email = "email"
        case sms = "sms"
