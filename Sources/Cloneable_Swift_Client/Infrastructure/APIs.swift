...
open class Cloneable_Swift_ClientAPIConfiguration: @unchecked Sendable {
    ...
    public init(
        basePath: String = "https://app.cloneable.ai/api/v1",
    ...
    public static let shared = Cloneable_Swift_ClientAPIConfiguration()
}
...
open class RequestBuilder<T>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: Cloneable_Swift_ClientAPIConfiguration

    /// Optional block to obtain a reference to the request's progress instance when available.
    public var onProgressReady: ((Progress) -> Void)?

    required public init(method: String, URLString: String, parameters: [String: any Sendable]?, headers: [String: String] = [:], requiresAuthentication: Bool, apiConfiguration: Cloneable_Swift_ClientAPIConfiguration = Cloneable_Swift_ClientAPIConfiguration.shared) {
        self.method = method
