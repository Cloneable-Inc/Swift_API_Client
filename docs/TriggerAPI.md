...
let createTriggerRequest = createTrigger_request(name: "name_example", description: "description_example", code: "code_example", runtime: "runtime_example", schedule: "schedule_example", type: "type_example", environmentVariables: "TODO") // CreateTriggerRequest | Body (optional)
...
let id = "id_example" // String | 
let updateTriggerRequest = updateTrigger_request(name: "name_example", description: "description_example", code: "code_example", runtime: "runtime_example", schedule: "schedule_example", type: "type_example", environmentVariables: "TODO", enabled: false, inputSchema: updateTrigger_request_input_schema(parameters: [updateTrigger_request_input_schema_parameters_inner(name: "name_example", type: "type_example", _required: false)])) // UpdateTriggerRequest | Body (optional)
